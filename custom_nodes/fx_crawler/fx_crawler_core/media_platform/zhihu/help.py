...
from fx_crawler_core.tools.crawler_util import extract_text_from_html
from fx_crawler_core.tools.user_hash import anonymize_user_id, mask_nickname
...
def sign(url: str, cookies: str) -> Dict:
    ...
    if not ZHIHU_SGIN_JS:
        with open(pkg_path("libs/zhihu.js"), mode="r", encoding="utf-8-sig") as f:
