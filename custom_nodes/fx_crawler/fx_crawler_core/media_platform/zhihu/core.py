...
from fx_crawler_core import config
from fx_crawler_core._paths import pkg_path
from fx_crawler_core.constant import zhihu as constant
from fx_crawler_core.base.base_crawler import AbstractCrawler
from fx_crawler_core.model.m_zhihu import ZhihuContent, ZhihuCreator
from fx_crawler_core.proxy.proxy_ip_pool import IpInfoModel, create_ip_pool
from fx_crawler_core.store import zhihu as zhihu_store
from fx_crawler_core.tools import utils
from fx_crawler_core.tools.cdp_browser import CDPBrowserManager
from fx_crawler_core.var import crawler_type_var, source_keyword_var
    ...
    async def start(self) -> None:
        ...
        async with async_playwright() as playwright:
            ...
            if config.ENABLE_CDP_MODE:
                ...
                await self.browser_context.add_init_script(path=pkg_path("libs/stealth.min.js"))
