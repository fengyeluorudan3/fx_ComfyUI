...
import os as _os
STOP_WORDS_FILE = _os.path.join(_os.path.dirname(_os.path.dirname(_os.path.abspath(__file__))), "docs", "hit_stopwords.txt")

# Chinese font file path
FONT_PATH = _os.path.join(_os.path.dirname(_os.path.dirname(_os.path.abspath(__file__))), "docs", "STZHONGS.TTF")
