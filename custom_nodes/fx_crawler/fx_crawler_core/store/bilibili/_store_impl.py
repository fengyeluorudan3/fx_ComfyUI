...
from fx_crawler_core.base.base_crawler import AbstractStore
from fx_crawler_core.database.db_session import get_session
from fx_crawler_core.database.models import BilibiliVideoComment, BilibiliVideo, BilibiliUpDynamic
from fx_crawler_core.tools.async_file_writer import AsyncFileWriter
from fx_crawler_core.tools import utils, words
from fx_crawler_core.var import crawler_type_var
from fx_crawler_core.database.mongodb_store_base import MongoDBStoreBase
...
class BiliExcelStoreImplement:
    ...
    def __new__(cls, *args, **kwargs):
        from fx_crawler_core.store.excel_store_base import ExcelStoreBase
